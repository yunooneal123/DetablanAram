...
<body>
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed">
            <nav class="blue navbar-color">
                <div class="nav-wrapper"><h1>&nbsp&nbsp Glace Water Refilling Station </h1>
                    <ul class="left">                      
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Water</a>
            </li>
                <li class="no-padding">
  ...
  <footer class="blue page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by BSIT 4 - H <a class="grey-text text-lighten-4" href="#">Students</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
